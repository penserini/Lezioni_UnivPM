...
# Utilizzo di metodi "protected" per accedere a variabili "private", della classe "Persona"
print(Studente1._getNome() + " " + Studente1._getCognome() + " - " + Studente1._getEta() + " anni")
